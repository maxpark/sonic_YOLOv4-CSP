...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        if os.path.isfile(cache_path):
            ...
            # print("torch.load(cache_path) : ", cache, cache_path)
        ...
        # print("self.label_files : ", self.label_files[:10])
    ...
    def cache_labels(self, path='labels.cache3'):
        ...
        # print("self.img_files, self.label_files : ", self.img_files[:10], self.label_files[:10])
        for (img, label) in pbar:
            # print("img : ", img)   # ***.jpg
            # print("label : ", label) #  ***.txt
            try:
                l = []
                im = Image.open(img)
                ...
                # print("os.path.isfile(label) : ", os.path.isfile(label))
                if os.path.isfile(label):
                    with open(label, 'r') as f:
                        # if os.path.isfile(img):
                        #     with open(img, 'r') as f:0
...
class LoadImagesAndLabels9(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        # Check cache
        self.label_files = img2label_paths(self.img_files)  # labels
        # self.label_files = open(/workspace/dataset/COCO2017/train.txt)
        # with open(self.label_files, 'r') as k:
        #     k = k.read().splitlines()
        #     par = str(k.parent) + os.sep
        #
