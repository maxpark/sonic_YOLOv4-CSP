...
"""hyper parameters"""
json_file_path = '/data/chanyong/coco/annotations/instances_val2017.json'
images_dir_path = '/data/chanyong/coco/val2017/'
output_path = '/workspace/dataset/COCO2017/json2txt/'
...
for ant in tqdm(annotations):
    ...
    with open(n, 'a') as f:
        ...
        a = (name_box_id[name][1][0]/img_shape[1])  # x coordinate
        b = (name_box_id[name][1][1]/img_shape[0])  # y coordinate
        c = (name_box_id[name][1][2]/img_shape[1])  # width
        d = (name_box_id[name][1][3]/img_shape[0])  # height
        # print(k)
        # print('j[1] : ', j[1][:])
